...
osThreadId GreenLedFlashHandle;
osThreadId RedLedFlashHandle;
osThreadId OrangeLedFlashHandle;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_GreendLedTask */
/**
* @brief Function implementing the GreenLedFlash thread.
* @param argument: Not used
* @retval None
*/
...
void GreendLedTask(void const * argument)
{
  ...
  /* USER CODE END GreendLedTask */
}

/* USER CODE BEGIN Header_RedLedTask */
/**
* @brief Function implementing the RedLedFlash thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the OrangeLedFlash thread.
* @param argument: Not used
* @retval None
*/
